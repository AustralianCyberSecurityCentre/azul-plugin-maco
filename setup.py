...
setup(
    name="azul-plugin-maco",
    description="Extract malware configuration with scripts using the maco framework.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_maco"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-maco = azul_plugin_maco.main:main",
        ]
    },
