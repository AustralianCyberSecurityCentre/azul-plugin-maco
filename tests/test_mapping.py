                ...
                events=[
                    Event(
                        ...
                        features={
                            "family": [FV("malware")],
                            "client": [
                                FV("tcp://1.2.3.4:5678", label="tcp://9.10.11.12:13"),
                                FV("tcp://14.15.16.17:1819", label="tcp://20.21.22.23:24"),
                            ],
                            "connection": [
                                FV("tcp://20.21.22.23:24", label="upload"),
                                FV("tcp://9.10.11.12:13", label="upload"),
                            ],
                            "connection_upload": [FV("tcp://20.21.22.23:24"), FV("tcp://9.10.11.12:13")],
                        },
                    )
                ],
            ),
            ...
            JobResult(
                ...
                events=[
                    ...
                    Event(
                        ...
                        sha256="e9c83ff8680a99f5d96cb724e9bfe32d4ca87068172874439b4fe671564a9770",
                        relationship={
                            "action": "deobfuscated",
                            "datatype": "payload",
                    ...
                    Event(
                        ...
                        sha256="29cf67d7d3ff86c378e3c56dce4fae227022b71cf4350b1049dff7356f77f674",
                        relationship={
                            "action": "extracted",
                            "datatype": "payload",
                            "obfuscation_type": "base64 -> AES",
                ...
                events=[
                    Event(
                        ...
                        features={
                            ...
                            "category": [FV("adware")],
                            "client": [
                                FV("tcp://12.3.2.1:9584", label="tcp://73.21.32.43:4"),
                                FV("tcp://16.8.4.2:1541", label="tcp://tcpdomain.com:400"),
                                FV("tcp://127.7.4.1:21737"),
                                FV("udp://12.1.1.1:2131", label="udp://73.21.32.43:42"),
                                FV("udp://12.1.1.1:2131", label="udp://udpdomain.com:42"),
                                FV("udp://127.2.3.9:21784"),
                            ],
                            ...
                            "connection": [
                                FV("dns://123.21.21.21:9", label="other"),
                                FV("ftp://apple:bad@somewhere:553/temporary.exe", label="c2"),
                                FV("http:///thebad", label="other"),
                                FV("http://differenturi.com:221", label="other"),
                                FV(
                                    "https://user:pass@blarg.com:221/malz?yeah=453&blah=yeah#a_part_of_the_page",
                                    label="c2",
                                ),
                                FV("icmp://192.168.0.80", label="c2"),
                                FV("icmp://malicious.com", label="other"),
                                FV("smtp://user:pass@here.com:432", label="upload"),
                                FV("socks5://capsicum:red@192.168.0.80:56", label="tunnel"),
                                FV("ssh://user:pass@bad.malware:99", label="download"),
                                FV("tcp://73.21.32.43:4", label="c2"),
                                FV("tcp://tcpdomain.com:400", label="upload"),
                                FV("udp://73.21.32.43:42", label="decoy"),
                                FV("udp://udpdomain.com:42", label="decoy"),
                            ],
                            "connection_c2": [
                                FV("ftp://apple:bad@somewhere:553/temporary.exe"),
                                FV("https://user:pass@blarg.com:221/malz?yeah=453&blah=yeah#a_part_of_the_page"),
                                FV("icmp://192.168.0.80"),
                                FV("tcp://73.21.32.43:4"),
                            ],
                            "connection_decoy": [
                                FV("udp://73.21.32.43:42"),
                                FV("udp://udpdomain.com:42"),
                            ],
                            "connection_download": [FV("ssh://user:pass@bad.malware:99")],
                            "connection_other": [
                                FV("dns://123.21.21.21:9"),
                                FV("http:///thebad"),
                                FV("http://differenturi.com:221"),
                                FV("icmp://malicious.com"),
                            ],
                            "connection_tunnel": [FV("socks5://capsicum:red@192.168.0.80:56")],
                            "connection_upload": [
                                FV("smtp://user:pass@here.com:432"),
                                FV("tcp://tcpdomain.com:400"),
                            ],
                            "constants": [
                            ...
                            "path": [
                                FV("C:/Windows/system32", label="install"),
                                FV("C:/user/USERNAME/xxxxx/xxxxx/", label="logs"),
                                FV("\\here\\is\\some\\place", label="install"),
                            ],
                            "path_install": [
                                FV("C:/Windows/system32"),
                                FV("\\here\\is\\some\\place"),
                            ],
                            "path_logs": [FV("C:/user/USERNAME/xxxxx/xxxxx/")],
                            "pipe": [FV("xiod")],
                    ...
                    Event(
                        ...
                        sha256="053ec394f2cfed3507e682b59d7b2397f5eb49163acc34a934e9b3da6ea766e4",
                        relationship={"action": "extracted", "datatype": "payload"},
                        data=[
                            EventData(
    ...
    def test_complex_child(self):
        ...
        self.assertJobResult(
            ...
            JobResult(
                ...
                events=[
                    Event(
                        sha256="1239ed4331b652fd9a227355f9ce1568274e1811fe18f9fb38cb404a98536fab",
                        features={
                            "attack": [FV("T1204.002")],
                            "category": [FV("adware")],
                            "family": [FV("scuba")],
                ...
                events=[
                    Event(
                        ...
                        features={
                            "family": [FV("malware")],
                            "connection": [
                                FV("https://example.com:443", label="c2"),
                                FV("bad.example.com:8080", label="download"),
                            ],
                            "connection_c2": [FV("https://example.com:443")],
                            "connection_download": [FV("bad.example.com:8080")],
                        },
                    )
                ],
            ),
